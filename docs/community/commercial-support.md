...
[Aletyx](https://aletyx.ai) offers the [Aletyx Enterprise Build of Drools](https://aletyx.ai/build-of-drools/) and the [Aletyx Enterprise Build of Kogito](https://aletyx.ai/build-of-kogito/), both based on Apache KIE technologies and extended with features for enterprise environments with a flat [pricing model](https://aletyx.ai/pricing/). Aletyx consulting [services](https://aletyx.ai/consulting-services/) are available to support modernization efforts, migration from legacy or discontinued versions, and the adoption of hybrid enterprise AI architectures that integrate rules, processes, GenAI and AI agents for decision and workflow automation. Aletyx also provides [training](https://aletyx.ai/training-programs/) on Drools, Kogito, and DMN for developers, architects, and business analysts.
